...
Insert into BookingDetails values(1,2);
Insert into BookingDetails values(1,3);
Insert into BookingDetails values(2,4);
Insert into BookingDetails values(3,5);
Insert into BookingDetails values(3,6);
Insert into BookingDetails values(4,1);
Insert into BookingDetails values(5,2);
Insert into BookingDetails values(5,3);
Insert into BookingDetails values(5,4);
